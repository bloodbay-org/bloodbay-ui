            ...
            <Spin spinning={cases.inProgress || files.inProgress}>
                {
                                ...
                                files.linkedToCaseFiles.map((fileMetadata: FileMetadata) =>
                                    <div style={{
                                        ...
                                        <Button type="primary" key="3"
                                                onClick={() => openAttachment(fileMetadata.mediaLink)}>View
                                            attachment</Button>
                    ...
                    </Card> : <ResultComponent status="error" title="Case not found!" subTitle="It could be removed or just a wrong ID... Life is full of mysteries."/>
                }
            </Spin>
        </div>
    );
